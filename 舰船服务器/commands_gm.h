...
static int handle_dbgqdata(ship_client_t* c, const char* params) {
    ...
    if (*params) {
        if (!strcmp(params, "quest1")) {
            ...
            PRINT_HEX_LOG(GM_LOG, c->bb_pl->quest_data1, PSOCN_STLENGTH_BB_DB_QUEST_DATA1);
        ...
        if (!strcmp(params, "quest2")) {
            ...
            PRINT_HEX_LOG(GM_LOG, c->bb_pl->quest_global_flags.all, PSOCN_DATALENGTH_BB_DB_QUEST_GLOBAL_FLAGS_DATA);
