...
//( 00000010 )   65 EF 44 43 B2 58 0F C3   07 00 00 00 01 3F 3C 0F  e顳C瞂.?....?<.
// 
//( 00000000 )   20 00 62 00 00 00 00 00   60 06 00 00 01 0A 72 00   .b.....`.....r.
//( 00000010 )   D4 ED 20 43 0A 46 E5 C2   07 00 00 00 01 D4 3A 0F  皂 C.F迓.....?.
// 
//( 00000000 )   20 00 62 00 00 00 00 00   60 06 00 00 01 0A 73 00   .b.....`.....s.
//( 00000010 )   A5 67 C7 42 DC 75 97 C3   07 00 00 00 01 DE 3A 0F  荁躸椕.....?.
// 
//( 00000000 )   20 00 62 00 00 00 00 00   60 06 00 00 01 08 74 00   .b.....`.....t.
//( 00000010 )   D3 17 68 43 B3 CF 89 C1   07 00 00 00 01 A9 7B 00  ?hC诚壛.....﹞.
...
// 0x84: subcmd_bb_boss_act_ofp_u_sp (指令生效范围; 仅限游戏; 不支持 Episode 3)
typedef struct subcmd_bb_boss_act_ofp_u_sp {
    bb_pkt_hdr_t hdr;
    unused_hdr_t shdr;
    ...
    uint16_t unknown_a3;
    uint16_t unused;
} PACKED subcmd_bb_boss_act_ofp_u_sp_t;
