...
static cmd_map_st c_cmd_names[] = {
    ...
    { GAME_SUBCMD62_TYPE, "GAME_COMMAND2_TYPE", "玩家指令" },
    ...
    { CLIENT_UNKNOW_6A, "CLIENT_UNKNOW_6A", "未知06" },
    { GAME_SUBCMD6C_TYPE, "GAME_COMMANDC_TYPE", "客户端至服务器指令" },
    { GAME_SUBCMD6D_TYPE, "GAME_COMMANDD_TYPE", "创建房间指令" },
    ...
    { CLIENT_UNKNOW_91, "CLIENT_UNKNOW_91", "未知91" },
    ...
    { GAME_COMMAND_BA_TYPE, "EP3_COMMAND_TYPE", "客户端至服务器指令" },
    ...
    { GAME_COMMAND_CA_TYPE, "EP3_SERVER_DATA_TYPE", "客户端至服务器指令" },
    ...
    { BB_GUILD_GET_TARGET_DATA, "BB_GUILD_UNK_0EEA", "0x0EEA" },
    ...
    { BB_GUILD_INITIALIZATION_DATA, "BB_GUILD_INITIALIZATION_DATA", "0x12EA" },
    ...
    { BB_GUILD_UNLOCK_PRIVILEGE_ITEMS_INFO, "BB_GUILD_PRIVILEGE_LIST", "0x19EA" },
    { BB_GUILD_REQ_PRIVILEG_ITEMS_LIST, "BB_GUILD_BUY_SPECIAL_ITEM", "0x1AEA" },
    { BB_GUILD_UNLOCK_PRIVILEG_ITEM, "BB_GUILD_UNK_1BEA", "0x1BEA" },
