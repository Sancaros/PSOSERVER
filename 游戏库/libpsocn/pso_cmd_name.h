...
static cmd_map_st c_cmd_names[] = {
    ...
    { BB_GUILD_GET_TARGET_GUILD_DATA, "BB_GUILD_UNK_0EEA", "0x0EEA" },
    ...
    { BB_GUILD_BUY_SPECIAL_ITEM, "BB_GUILD_BUY_SPECIAL_ITEM", "0x1AEA" },
    { BB_GUILD_UNLOCK_GUILD_SPECIAL_ITEM, "BB_GUILD_UNK_1BEA", "0x1BEA" },
