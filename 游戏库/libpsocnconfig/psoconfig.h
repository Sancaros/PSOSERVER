...
static c_cmd_map_st c_cmd_names[] = {
    ...
    { bb_guild_command, "BB_GUILD_COMMAND", "0x00EA 公会指令集" },
    { bb_guild_create, "BB_GUILD_CREATE", "0x01EA 创建公会" },
    { bb_guild_unk_02ea, "BB_GUILD_UNK_02EA", "0x02EA" },
    { bb_guild_member_add, "BB_GUILD_MEMBER_ADD", "0x03EA 公会成员新增" },
    { bb_guild_unk_04ea, "BB_GUILD_UNK_04EA", "0x04EA" },
    { bb_guild_member_remove, "BB_GUILD_MEMBER_REMOVE", "0x05EA 公会成员移除" },
    { bb_guild_unk_06ea, "BB_GUILD_UNK_06EA", "0x06EA" },
    { bb_guild_member_chat, "BB_GUILD_CHAT", "0x07EA 公会聊天" },
    { bb_guild_member_setting, "BB_GUILD_MEMBER_SETTING", "0x08EA 公会成员设置关联其他成员设置" },
    ...
    { bb_guild_invite, "BB_GUILD_INVITE", "0x0DEA 公会邀请" },
    { bb_guild_unk_0eea, "BB_GUILD_UNK_0EEA", "0x0EEA" },
    { bb_guild_member_flag_setting, "BB_GUILD_MEMBER_FLAG_SETTING", "0x0FEA 公会标志设置" },
    { bb_guild_dissolve, "BB_GUILD_DISSOLVE", "0x10EA 解散公会" },
    { bb_guild_member_promote, "BB_GUILD_MEMBER_PROMOTE", "0x11EA 公会成员升职" },
    { bb_guild_unk_12ea, "BB_GUILD_UNK_12EA", "0x12EA" },
    { bb_guild_lobby_setting, "BB_GUILD_LOBBY_SETTING", "0x13EA 公会大厅设置" },
    { bb_guild_member_title, "BB_GUILD_MEMBER_TITLE", "0x14EA 公会头衔" },
    { bb_guild_full_data, "BB_GUILD_FULL_DATA", "0x15EA 公会完整数据" },
    { bb_guild_unk_16ea, "BB_GUILD_UNK_16EA", "0x16EA" },
    { bb_guild_unk_17ea, "BB_GUILD_UNK_17EA", "0x17EA" },
    { bb_guild_buy_privilege_and_point_info, "BB_GUILD_BUY_PRIVILEGE_AND_POINT_INFO", "0x18EA 公会点数和特典信息" },
    { bb_guild_privilege_list, "BB_GUILD_PRIVILEGE_LIST", "0x19EA 公会特典列表" },
    { bb_guild_unk_1aea, "BB_GUILD_UNK_1AEA", "0x1AEA" },
    { bb_guild_unk_1bea, "BB_GUILD_UNK_1BEA", "0x1BEA" },
    { bb_guild_ranking_list, "BB_GUILD_RANKING_LIST", "0x1CEA 公会排行榜" },
