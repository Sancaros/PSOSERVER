...
*/
extern int pso_prs_compress(const uint8_t* src, uint8_t** dst, size_t src_len);
...
*/
extern int pso_prs_archive(const uint8_t* src, uint8_t** dst, size_t src_len);
...
*/
extern int pso_prs_archive2(const uint8_t* src, uint8_t* dst, size_t src_len,
    size_t dst_len);
...
*/
extern size_t pso_prs_max_compressed_size(size_t len);
...
/* Decompress PRS-compressed data from a memory buffer.
   ...
   psoarchive-error.h). Returns the size of the decompressed output on success.
*/
extern int pso_prs_decompress_buf(const uint8_t* src, uint8_t** dst, size_t src_len);
