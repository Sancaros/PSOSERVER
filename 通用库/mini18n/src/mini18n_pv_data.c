...
/* _wcsdup isn't technically part of C99 or anything, so there's at least a
   possibility it isn't defined on the system. */
static wchar_t *_wcsdup(const wchar_t *string) {
