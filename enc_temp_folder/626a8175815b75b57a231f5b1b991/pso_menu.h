...
static pso_menu_t pso_game_create_menu_pc[][4] = {
    {"DATABASE/US", MENU_ID_DATABASE, MENU_ID_GAME_TYPE, 0x0004},
    {"允许 PSOv1", MENU_ID_GAME_TYPE, 0, 0x0004},
    {"PSOv2 独享", MENU_ID_GAME_TYPE, 1, 0x0004},
    {"PSOPC 独享", MENU_ID_GAME_TYPE, 2, 0x0004},
    //{"上级菜单", MENU_ID_GAME_TYPE, 0xFF, 0x0004},
};

static pso_menu_t pso_game_create_menu_bb[][4] = {
    {"DATABASE/US", MENU_ID_DATABASE, MENU_ID_GAME_TYPE, 0x0004},
    {"PSOBB 独享", MENU_ID_GAME_TYPE, 0, 0x0004},
    {"允许所有版本", MENU_ID_GAME_TYPE, 1, 0x0004},
    {"允许 PSOv1", MENU_ID_GAME_TYPE, 2, 0x0004},
    {"允许 PSOv2", MENU_ID_GAME_TYPE, 3, 0x0004},
    {"允许 PSODC", MENU_ID_GAME_TYPE, 4, 0x0004},
    {"允许 PSOGC", MENU_ID_GAME_TYPE, 5, 0x0004},
    {"取消创建", MENU_ID_GAME_TYPE, 0xFF, 0x0004},
};

static pso_menu_t pso_game_drop_menu_bb[][4] = {
    {"DATABASE/US", MENU_ID_DATABASE, MENU_ID_GAME_DROP, 0x0004},
    {"默认掉落模式", MENU_ID_GAME_DROP, 0, 0x0004},
    {"独立掉落模式", MENU_ID_GAME_DROP, 1, 0x0004},
    {"随机颜色独立模式", MENU_ID_GAME_DROP, 2, 0x0004},
    {"上级菜单", MENU_ID_GAME_DROP, 0xFF, 0x0004},
};

static pso_menu_t pso_block_list_menu_last[][4] = {
    {"DATABASE/US", MENU_ID_DATABASE, MENU_ID_BLOCK, 0x0004},
    {"返回选择舰船", MENU_ID_BLOCK, ITEM_ID_LAST, 0x0004},
    {"断开连接", MENU_ID_BLOCK, ITEM_ID_DISCONNECT, 0x0004},
};

static pso_menu_t pso_block_list_menu_last_dc[][4] = {
    {"DATABASE/US", MENU_ID_DATABASE, MENU_ID_BLOCK, 0x0004},
    {"SELECT SHIP", MENU_ID_BLOCK, ITEM_ID_LAST, 0x0004},
    {"DISCONNECT", MENU_ID_BLOCK, ITEM_ID_DISCONNECT, 0x0004},
};
...
static pso_menu_t pso_player_menu[][4] = {
    {"DATABASE/US",  MENU_ID_PLAYER, 0xFFFFFFFF,      0x0004},
...
static pso_menu_t pso_player_menu_info[][4] = {
    {"DATABASE/US",  MENU_ID_PL_INFO_LIST,       0xFFFFFFFF,  0x0004},
    ...
    {"上级菜单",     MENU_ID_PL_INFO_LIST,   ITEM_ID_LAST,          0x0004},
...
static pso_menu_t pso_player_menu_section[][4] = {
    ...
    {"上级菜单",          MENU_ID_PLAYER,  ITEM_ID_LAST, 0x0004},
    {"关闭菜单",          MENU_ID_PLAYER,  ITEM_ID_DISCONNECT, 0x0004}
};
