...
#define CHARACTER_COMMON_BANK "character_common_bank"
#define CHARACTER_COMMON_BANK_ITEMS "character_common_bank_items"
#define CHARACTER_COMMON_BANK_ITEMS_BACKUP "character_common_bank_items_backup"
